                ...
                Column(
                    ...
                    Column(
                        ...
                        LoginFields(
                            ...
                            usernameValue = state.value.usernameInput,
                            passwordValue = state.value.passwordInput,
                            onUsernameChange = { input, error ->
                                onEvent(LoginScreenEvents.UsernameInputChanged(input))
                            },
                            onPasswordChange = { input, error ->
                                onEvent(LoginScreenEvents.PasswordInputChanged(input))
                            }
                        )
